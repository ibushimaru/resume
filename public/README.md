...
#### 6年間の翻訳活動
- 2作品で公式採用を獲得
- Vault of the Void（40,000語規模）の翻訳を完遂
- 複数ジャンル（ローグライク、メトロイドヴァニア等）での翻訳経験
- 翻訳チーム（最大16名）のマネジメント経験

#### 技術的な理解
- GameMaker Studio、Undertalemodtoolなどの実務使用経験
- CATツール（Crowdin、OmegaT）の活用
- 機械翻訳（Google Translate、DeepL）との協働経験

### 2. コミュニティ活動

#### 運営・参加している活動
- ゲーム翻訳会LEVELUP!の共同主催（毎月開催）
- TGSゲーム翻訳者名刺交換会の主催
- Discord「日本語化作業所互助会」での活動
- 翻訳ノウハウの記事執筆と発表
...
#### 現在取り組んでいること
- 生成AIツール（Claude Code、Dify）の学習と活用
- ローカルLLMを用いた翻訳支援の研究
- MCP（Model Context Protocol）の実装実験

![Difyを用いた翻訳AIワークフロー](./dify-workflow.png)
*Difyで開発中のゲーム翻訳特化AIシステム - 文脈を保持しながら用語統一を実現*

#### これまでの経験
- 機械設計（CAD）とRPA開発の実務経験
- 業務効率化ツールの開発
- 技術文書の作成と管理

### 4. 今後貢献したい分野

- 生成AIを活用した翻訳品質向上のための仕組み作り
- ゲーム特有の表現に対応した用語集の整備
- 翻訳チームの効率的な運営
- LLM開発の支援
...
私は「この世界にある全てのゲームを日本語でプレイできるようにしたい」という考えのもと、6年間ゲームの翻訳に関わってきました。
最初はボランティアで翻訳を始め、後に公式に採用されるようになり、コミュニティを運営し、生成AIと一緒に仕事をする方法を模索してきました。このような泥臭い経験は、今のように翻訳業界が大きく変わっている時代だからこそ役立つと確信しています。
...
*この履歴書は [tsukuboshi/honox-resume-template](https://github.com/tsukuboshi/honox-resume-template) を使用して作成されました。*